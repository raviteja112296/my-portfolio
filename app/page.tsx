    ...
    >
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'grid', gridTemplateColumns: '1fr auto', gap: '64px', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <a href="https://github.com/Raviteja112296" target="_blank" rel="noreferrer" className="btn-secondary">
              ...
              <a href="https://www.linkedin.com/in/ravi-raviteja" target="_blank" rel="noreferrer" className="btn-secondary">
      ...
      >
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', textAlign: 'center', position: 'relative' }}>
          ...
          <p style={{ fontSize: '12px', color: '#f3f5f8', fontFamily: "'DM Mono', monospace", marginTop: '64px' }}>
